    ...
    <div class="content-wrapper" style="margin-top: 100px;">
        <section class="content">
            <div class="container-fluid">
                ...
                @if (session('success'))
                    <div
                        class="alert alert-success alert-dismissible fade show border-0 shadow-sm d-flex align-items-center gap-2">
                    ...
                    <div class="card-body">
                        <form action="{{ route('user.update', $user->id) }}" method="POST">
                            ...
                            <div class="text-end mt-4 d-flex justify-content-end gap-2">
                                ...
                                <button type="submit" class="btn text-white d-flex align-items-center gap-1"
