...
<section class="hero position-relative"
    ...
    <div class="container">
        <div class="row g-4">
                ...
                <a href="{{ route('persil.index') }}" class="text-decoration-none">
                    <div class="card shadow-sm border-0 h-100 rounded-4">
                        <div class="card-body d-flex align-items-center gap-3">
                            <i data-feather="map-pin" class="text-success" width="32"></i>
                            <div>
                                <h6 class="fw-bold mb-0">Kelola Persil</h6>
                                <small class="text-muted">Lihat & edit data persil</small>
                            </div>
                        </div>
                    </div>
                </a>
            ...
            <div class="col-md-4">
                <a href="{{ route('sengketa_persil.index') }}" class="text-decoration-none">
                    <div class="card shadow-sm border-0 h-100 rounded-4">
                        <div class="card-body d-flex align-items-center gap-3">
                            <i data-feather="shield-off" class="text-warning" width="32"></i>
                            <div>
                                <h6 class="fw-bold mb-0">Sengketa</h6>
                                <small class="text-muted">Monitoring sengketa lahan</small>
                            </div>
                        </div>
                    </div>
                </a>
            ...
            <div class="col-md-4">
                <a href="{{ route('dokumen_persil.index') }}" class="text-decoration-none">
                    <div class="card shadow-sm border-0 h-100 rounded-4">
                        <div class="card-body d-flex align-items-center gap-3">
                            <i data-feather="folder" class="text-success" width="32"></i>
                            <div>
                                <h6 class="fw-bold mb-0">Dokumen</h6>
                                <small class="text-muted">Manajemen dokumen persil</small>
                            </div>
                        </div>
                    </div>
                </a>
    ...
    <section class="py-5" style="background:#f6f8f6;">
    <div class="container">

        <div class="text-center mb-5">
            <h2 class="fw-bold text-success">Ringkasan Data Pertanahan</h2>
            <p class="text-muted">Data real-time dari sistem</p>
        </div>
        ...
        <div class="row g-4">
            ...
            <div class="col-md-4 col-lg-2">
                <div class="card border-0 shadow-sm text-center h-100 rounded-4">
                    <div class="card-body">
                        <i data-feather="map" class="text-success mb-2" width="36"></i>
                        <h6 class="fw-semibold">Persil</h6>
                        <h3 class="fw-bold text-success">{{ $totalPersil }}</h3>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4 col-lg-2">
                <div class="card border-0 shadow-sm text-center h-100 rounded-4">
                    <div class="card-body">
                        <i data-feather="users" class="text-success mb-2" width="36"></i>
                        <h6 class="fw-semibold">Warga</h6>
                        <h3 class="fw-bold text-success">{{ $totalWarga }}</h3>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4 col-lg-2">
                <div class="card border-0 shadow-sm text-center h-100 rounded-4">
                    <div class="card-body">
                        <i data-feather="layers" class="text-success mb-2" width="36"></i>
                        <h6 class="fw-semibold">Penggunaan</h6>
                        <h3 class="fw-bold text-success">{{ $totalPenggunaan }}</h3>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4 col-lg-3">
                <div class="card border-0 shadow-sm text-center h-100 rounded-4">
                    <div class="card-body">
                        <i data-feather="alert-triangle" class="text-warning mb-2" width="36"></i>
                        <h6 class="fw-semibold">Sengketa Persil</h6>
                        <h3 class="fw-bold text-warning">{{ $totalSengketa }}</h3>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4 col-lg-3">
                <div class="card border-0 shadow-sm text-center h-100 rounded-4">
                    <div class="card-body">
                        <i data-feather="file-text" class="text-success mb-2" width="36"></i>
                        <h6 class="fw-semibold">Dokumen Persil</h6>
                        <h3 class="fw-bold text-success">{{ $totalDokumen }}</h3>
                    </div>
                </div>
            </div>
...
<a href="#developer-info" class="dev-float-btn" title="Tentang Pengembang">
    ...
    <div class="dev-box">
        ...
        <div class="dev-body text-center">
            ...
            <div class="dev-social">
                ...
                <a href="https://github.com/lindyhanan" target="_blank">
                    <i class="fab fa-github"></i>
                </a>
                <a href="https://instagram.com/lindyhanntys" target="_blank">
