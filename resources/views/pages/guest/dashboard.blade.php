...
<section class="hero position-relative" style="background: url('{{ asset('assets/img/contoh2.jpg') }}') center/cover no-repeat; height: 80vh;">
  ...
  <div class="container h-100 d-flex flex-column justify-content-center align-items-center text-center text-white position-relative">
      ...
      <div>
          <a href="{{ route('warga.create') }}" class="btn text-white px-4 py-2 me-2 rounded-pill shadow-sm animate__animated animate__fadeInUp animate__delay-1s" style="background-color:#2e7d32;">
              <i class="fas fa-plus-circle me-1"></i> Tambah Warga
          </a>
          <a href="{{ route('penggunaan.index') }}" class="btn btn-outline-light px-4 py-2 rounded-pill shadow-sm animate__animated animate__fadeInUp animate__delay-1s">
