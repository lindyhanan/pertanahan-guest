                ...
                <div class="row justify-content-center">
                    <div class="col-md-9 col-lg-8"> {{-- Lebar Optimal --}}
                        ...
                        <div class="text-center mb-4">
                            <h2 class="fw-bold text-success">🏡 Tambah Data Persil</h2>
                            <p class="text-muted">Masukkan rincian lengkap untuk persil tanah baru.</p>
                        </div>
                        ...
                        <div class="card border-0 shadow-sm mb-5 rounded-3" style="background-color:#f8f9f8;">
                            ...
                            <div class="card-header d-flex align-items-center gap-2"
                                ...
                                <h6 class="mb-0 fw-semibold">Formulir Persil Baru</h6>
                            </div>
                                ...
                                <form action="{{ route('persil.store') }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="text" name="pemilik_warga_id"
                                                ...
                                                value="{{ old('pemilik_warga_id') }}" required
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="number" step="0.01" min="0" name="luas_m2"
                                                ...
                                                value="{{ old('luas_m2') }}" required placeholder="Contoh: 150.75">
                                            @error('luas_m2')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="alamat_lahan"
                                            ...
                                            value="{{ old('alamat_lahan') }}" required
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="text" name="rt"
                                                ...
                                                value="{{ old('rt') }}" placeholder="Contoh: 005">
                                            @error('rt')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="text" name="rw"
                                                ...
                                                value="{{ old('rw') }}" placeholder="Contoh: 002">
                                            @error('rw')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="text-end mt-4 pt-3 border-top d-flex justify-content-end gap-2">
                                        <a href="{{ route('persil.index') }}"
                                            ...
                                            <i data-feather="arrow-left"></i> <span>Batal / Kembali</span>
                                        </a>
