...
@section('content')
        <div class="container">
          <div class="page-inner">
            ...
            >
              <div>
                <h3 class="fw-bold mb-3">Guest Pertanahan</h3>
                <h6 class="op-7 mb-2">Selamat Datang di Website Pertanahan</h6>
              </div>
              <div class="ms-md-auto py-2 py-md-0">
                <a href="#" class="btn btn-label-info btn-round me-2">Manage</a>
                <a href="{{route('warga.create')}}" class="btn btn-primary btn-round">Tambah Warga</a>
              </div>
            </div>
            <div class="row">
